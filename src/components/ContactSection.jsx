        ...
        <div className="sm:pt-16">
          ...
          <ul className="mt-8 space-y-3 text-[13px] text-ink/75">
            <li className="flex items-center gap-2.5">
              ...
              <a href="mailto:Info@bersihclean.com" className="transition hover:text-brand-deep">
        ...
        <div className="rounded-2xl bg-brand-mist p-8 sm:p-10">
          ...
          {state.succeeded ? (
            <div className="py-10 text-center">
              <span className="mx-auto grid h-11 w-11 place-items-center rounded-full bg-leaf/10 text-leaf">
              ...
              <p className="mt-1.5 text-[12.5px] text-ink/65">The team in Kuta will get back to you shortly.</p>
            </div>
          ) : (
            <form className="mt-6 space-y-4" onSubmit={onSubmit} noValidate={false}>
              ...
              <button
                ...
                className="w-full rounded-md bg-leaf py-3 text-[12.5px] font-semibold tracking-wide text-white transition hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-60"
              >
